...
{
    public class FoodSequenceService : BaseService<FoodSequence>, IFoodSequenceService
    {
        public FoodSequenceService(IFoodSequenceRepository repository) : base(repository)
        {
        }
    }
}
